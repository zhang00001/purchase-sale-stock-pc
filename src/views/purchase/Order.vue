      ...
      <el-table :data="tableData" border @selection-change="handleSelectionChange">
        <el-table-column label="操作" width="100" align="center">
          <template slot-scope="scope">
            <el-button @click="look(scope.row.status, scope.row.id)" type="text" size="small">查看</el-button>
        ...
        <el-table-column prop="number" label="采购订单编号" align="center"></el-table-column>
        ...
        <el-table-column prop="uid" label="采购人员" align="center"></el-table-column>
...
<script>
import { enumPurchase } from "@/utils/enums";
...
export default {
  ...
  methods: {
    print(row) {
      this.$common.printPdf("purchase", row.id);
    },
