  ...
  <div class="app-container">
      ...
      <el-form :inline="true" :model="form">
        <el-row>
          <el-form-item label="供应商 :" prop="supplier" label-width="78px">
            ...
            <el-select v-model="form.supplier" placeholder="请选择" @change="changeCus">
    ...
    <div class="box-table">
      <div class="inform-bottom">
        <el-button type="primary" @click="receivable('supplier')">付款</el-button>
        <el-button type="primary" @click="adjust('supplier')" class="search-btn">初期调整</el-button>
        <el-button type="primary" class="search-btn">打印</el-button>

        <div class="number" v-if="form.supplier">
          <p>供应商 : {{cus.name}}</p>
      ...
      <el-table :data="tableData" border>
        ...
        <el-table-column prop="create_time" label="业务时间"></el-table-column>
        <el-table-column prop="business_number" label="单据编号"></el-table-column>
        <el-table-column prop="maker_name" label="操作人"></el-table-column>
        <el-table-column prop="set_account_name" label="结算账户"></el-table-column>
        ...
        <!-- <el-table-column prop="money" label="累计应收款余额"></el-table-column> -->
...
export default {
  ...
  methods: {
    ...
    changeCus() {
      this.cus = this.supps.find(val => val.id == this.form.supplier);
    },
    getTabData(page) {
      if (this.form.supplier == "") {
        this.$message.error("请选择要查询的供应商");
      } else {
        supplier({ page: page, size: 10, ...this.form }).then(res => {
