  ...
  <div class="purchase-order">
      ...
      <div class="card-header">
        ...
        <el-radio-group v-model="headerStatus" size="medium">
          <el-radio-button v-for="item in orderStatus" :label="item.id" :key="item.id">{{item.name}}</el-radio-button>
				...
				<el-button class="build-botton" type="primary" @click="goBuild">新建盘点单</el-button>
      </div>
    ...
    <div class="box-table">
      <el-table :data="tableData" border @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="total" label="盘点总数" align="center"></el-table-column>
...
<script>
import { enumInventory } from "@/utils/enums"
  ...
  methods: {
    ...
    search() {
      this.init()
		...
		// 新建调拨单
		goBuild() {
			this.$router.push({ path: "/purchase/newBuild", query: { order: "7" } })
		},
