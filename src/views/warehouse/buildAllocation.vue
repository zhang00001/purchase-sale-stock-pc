  ...
  <div class="app-container">
		...
		<div class="box-card" style="height: auto;">
			...
			<el-table
				...
				<el-table-column prop="amount1" label="调拨数量" sortable></el-table-column>
				<el-table-column prop="zip" label="调出仓库当前总量"></el-table-column>
				<el-table-column prop="zip" label="调入仓库当前总量"></el-table-column>
			</el-table>
			
			<div class="botton-bottom">
				<el-button class="save-botton" type="primary" @click="save">保存草稿</el-button>
				<el-button class="purchase-botton" type="primary" @click="purchase">调拨</el-button>
			</div>
		</div>
  </div>
</template>
