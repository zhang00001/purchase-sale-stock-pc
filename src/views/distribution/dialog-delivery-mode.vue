    ...
    <el-dialog 
      ...
      <el-form ref="form" :model="form" :rules="rules">
				<template v-if="type == '送车'">
					...
					<el-row class="search-adress" v-if="orderType == 'add'">
					...
					<el-row class="search-adress" v-else>
						<el-form-item label="收件人地址 :" prop="email" class="input-large">
      ...
      <span slot="footer" class="dialog-footer" v-if="orderType == 'draft'">
...
export default {
  ...
  methods: {
		...
		// 发货方式详情
		showDetail(mode_address, mode, draft) {
			this.orderType = draft
			this.dialogVisible = true
			this.type = mode
			this.form = mode_address
...
.inform-dialog {
	...
	.search-adress {
		...
		.el-form-item {
			margin-bottom: 20px;
			.el-input:nth-child(2),.el-input:nth-child(3),.el-input:nth-child(4) {
				margin-left: 25px;
			}
		}
	}
