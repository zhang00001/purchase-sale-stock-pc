  ...
  <div class="purchase-order">
    <div class="box-inform">
      <div class="card-header">
        ...
        <el-button class="build-botton" type="primary" @click="goBuild">新建配货退货单</el-button>
      </div>
    ...
    <div class="box-table">
      <el-table :data="tableData" border @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="number" label="配货退货订单编号" align="center" width="140"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    // 新建销售订单
    goBuild() {
      this.$router.push({ path: "/purchase/newBuild", query: { order: "4" } })
    },
    ...
    look(status, id) {
      ...
      this.$router.push({
        ...
        query: { status: status, id: id, type: "2"}
      })
    },
