  ...
  <div class="app-container">
      ...
      <el-col :span="24" style="margin-top:20px;">
        <el-card class="box-card">
          <el-table :data="tableData" border style="width: 100%">
            ...
            <el-table-column prop="type" label="单据类型" v-if="status=='0'"></el-table-column>
            ...
            <el-table-column prop="supplier_name" label="供应商" v-if="status=='0'||status=='3'"></el-table-column>
            ...
            <el-table-column prop="put_number" label="数量" v-if="status=='0'"></el-table-column>
            <el-table-column
              prop="put_number"
              label="待出库数量"
    ...
    <el-dialog title="查询" :visible.sync="dialogVisible" width="38%">
      <el-form :model="ruleForm" ref="ruleForm" label-width="100px" class="demo-ruleForm">
        ...
        <el-form-item label="供应商" v-if="status=='0'||status=='1'||status=='2'||status=='3'">
          <el-select clearable filterable v-model="ruleForm.supplier">
