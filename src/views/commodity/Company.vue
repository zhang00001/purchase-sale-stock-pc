    ...
    <div class="box-inform">
			<el-form :inline="true" :model="form">
				<el-form-item label="名称:">
					...
					<el-button type="primary" @click="showDialog('add', 'company')" class="search-btn">新增单位</el-button>
			</el-form>
		</div>
			...
			<el-table
				...
				<el-table-column label="操作" align="center">
					<template slot-scope="scope">
						...
						<el-button slot="reference"  @click="showDialog('edit', 'company', scope.row.id)" type="text" size="small">编辑</el-button>
					</template>
				</el-table-column>
				<el-table-column
					prop="name"
...
import { companyList, companyDel } from "@/api/api.js"
